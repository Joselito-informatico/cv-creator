    ...
    <div className="flex border-b border-gray-800 bg-gray-900 p-1">
      <button
        ...
        className={`flex-1 px-4 py-2 text-sm font-medium transition-all ${
          editMode === 'gui' ? "bg-blue-600 text-white rounded shadow" : "text-gray-400 hover:text-gray-200"
        }`}
      >
        ✨ Modo Fácil
      </button>
      <button
        ...
        className={`flex-1 px-4 py-2 text-sm font-medium transition-all ${
          editMode === 'code' ? "bg-gray-700 text-white rounded shadow" : "text-gray-400 hover:text-gray-200"
        }`}
      >
        {"{ }"} Modo Código
      </button>
